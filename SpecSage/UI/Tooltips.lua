...
local function CreateHoverFrame()
    local frame = CreateFrame("GameTooltip", "SpecSageHoverTooltip", UIParent, "GameTooltipTemplate")
...
local function CreatePinFrame(index)
    local frame = CreateFrame("GameTooltip", "SpecSagePinnedTooltip" .. index, UIParent, "GameTooltipTemplate")
    frame:SetClampedToScreen(true)
    frame:EnableMouse(true)
...
BINDING_NAME_SPECSAGE_TOGGLE_TOME = "Toggle the Tome"
